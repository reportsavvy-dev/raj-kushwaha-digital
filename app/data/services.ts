...
export const services: Service[] = [
  makeService({
    ...
    summary: "Start with the business problem. We map the few channels that can solve it, define their roles and set one measurement plan.",
  ...
  makeService({
    ...
    summary: "Help the right pages get found, understood and used across organic search, answer surfaces and AI-assisted discovery.",
  ...
  makeService({
    ...
    summary: "Give people a reason to stop, follow and respond with platform-specific formats, a recognizable voice and practical community management.",
  ...
  makeService({
    ...
    shortName: "PPC",
    slug: "ppc-ads",
    summary: "Spend against clear intent, track what happens after the click and improve campaigns from qualified-result data.",
  ...
  makeService({
    ...
    shortName: "Branding",
    slug: "branding",
    summary: "Clarify what the business stands for, how it speaks and the visual cues people should remember.",
  ...
  makeService({
    ...
    summary: "Create a distinctive mark and flexible graphic toolkit that stays legible and consistent from a social avatar to print.",
    intro: "We develop or organise visual identities around how they will actually be used. The work can include a new logo, a protected master mark, colour and typography rules, social assets, stationery and a handoff that another designer can use without guessing.",
    deliverables: ["Logo and identity system", "Brand guidelines", "Social and campaign assets", "Production-ready source files"],
    ...
    testimonialQuote: "The approved identity should stay recognisable in every file, size, colour mode and channel.",
  ...
  makeService({
    ...
    summary: "Treat media, creative, landing pages and analytics as one acquisition loop, then scale only the tests that prove value.",
  ...
  makeService({
    ...
    summary: "Send the right message when a subscriber actually needs it, from first enquiry and onboarding to re-engagement.",
  ...
  makeService({
    ...
    summary: "Build the journey from offer to qualification and CRM handoff so sales receives useful context, not just form fills.",
  ...
  makeService({
    ...
    summary: "Find credible stories in the work, prepare useful press materials and take them to journalists who cover the subject.",
  ...
  makeService({
    ...
    summary: "Turn real customer questions and subject-matter expertise into articles, case studies and assets people can find and use.",
  ...
  makeService({
    ...
    summary: "Choose creators for relevance and trust, agree on clear rights and outcomes, and give the partnership room to sound natural.",
  ...
  makeService({
    ...
    summary: "Plan and build a fast, accessible website that answers buyer questions and makes the next step obvious on every screen.",
  ...
  makeService({
    ...
    summary: "We study the workflow your team uses today, keep what works and build a focused product around the steps that waste time or create errors.",
  ...
  makeService({
    ...
    summary: "Good automation has boundaries. We set permissions, review steps and fallbacks first, then use AI for repetitive work while people keep final judgment.",
