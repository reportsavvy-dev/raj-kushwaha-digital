...
const enhancements: Record<string, ServiceEnhancement> = {
  ...
  "ppc-ads": {
    ...
    process: [
      ...
      { step: "03", title: "Optimize downstream", text: "Search terms, lead feedback and conversion quality guide bids, budgets and creative—not click-through rate alone." },
    ],
...
const makeService = (input: ServiceInput): Service => {
  ...
  return {
    ...
    testimonial: {
      ...
      attribution: "Illustrative outcome · not a client testimonial",
...
export const services: Service[] = [
  ...
  makeService({
    ...
    intro: "Modern search spans ranked results, featured answers, AI Overviews, AI Mode and other generative systems. We improve the shared foundations—technical access, original expertise, clear information architecture, useful text and a fast experience—then measure where qualified discovery grows.",
